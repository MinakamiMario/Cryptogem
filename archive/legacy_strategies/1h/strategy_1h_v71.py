"""
V71: 1H Chaikin Vol v2 (V65 with lower ADX + wider RSI)
---------------------------------------------------------
V65 had INCREDIBLE risk metrics: PF 1.34, MaxDD 19.9%, 45.1% WR.
But only +40.6% return with 71 trades.
Try: ADX>15 + RSI 40-78 to get more entries while keeping the
...
class ChaikinVolV2_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
