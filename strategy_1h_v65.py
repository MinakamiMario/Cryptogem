"""
V65: 1H Chaikin Volatility + Momentum
---------------------------------------
Chaikin Volatility = rate of change of ATR.
Rising ATR = expanding volatility = potential breakout.
Use ATR expansion as entry confirmation alongside trend.

Entry:
1. Triple EMA aligned (20>50>100) + EMA20 rising
2. ATR(10) rising for 2 consecutive bars (volatility expanding)
3. Close > Close 3 bars ago (price momentum confirms vol expansion)
4. RSI 45-75
5. ADX > 20
...
class ChaikinVolMomentum1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
    ...
    def next(self):
        ...
        # Chaikin volatility: ATR expanding for 2 bars
