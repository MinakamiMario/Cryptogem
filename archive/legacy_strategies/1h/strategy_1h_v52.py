"""
V52: 1H Ultra-Wide ADX v4 (V49 + higher ADX + cooldown 4)
------------------------------------------------------------
V49 was +50.6% with 88 trades, ADX > 20.
Try ADX > 25 for even stronger trends + shorter cooldown (4 bars)
for more entries within the same strong trend.
...
class UltraWideADXv4_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
