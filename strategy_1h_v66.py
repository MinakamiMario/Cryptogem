"""
V66: 1H VWAP Trend v2 (Shorter VWMA + Lower ADX)
--------------------------------------------------
V55 was +53.4% with VWMA(20), ADX>20.
Try: shorter VWMA(14) for faster signal + ADX>15 for more entries.
Wider RSI range 40-78 for more entries during strong trends.
...
class VWAPTrendV2_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
