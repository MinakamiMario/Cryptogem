# Sprint 4 Scoreboard -- DC-Compatible Entry Mining (STRICT: PF > 1.05)

- **Dataset**: ohlcv_4h_kraken_spot_usd_526
- **Git**: 9a606d9
- **Generated**: 2026-02-17T20:14:07.842111+00:00
- **Total configs**: 10
- **GO (PF > 1.05)**: 7
- **PF threshold**: 1.05 (strict)
- **Exit mode**: dc (hybrid_notrl: DC TARGET + RSI RECOVERY + BB TARGET)
- Production GO threshold. Configs that pass advance to truth-pass.
