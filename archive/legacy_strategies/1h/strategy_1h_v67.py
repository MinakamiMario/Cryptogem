"""
V67: 1H VWAP Trend v3 (Longer VWMA + 7x ATR Stop)
----------------------------------------------------
V55 was +53.4% with VWMA(20), 6x ATR stop.
Try: longer VWMA(30) for stronger institutional signal + 7x ATR for
even wider trailing stop to let winners run longer.
Cooldown 6 for more entries within trends.
...
class VWAPTrendV3_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
