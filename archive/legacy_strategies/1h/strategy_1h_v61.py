...
2. Aroon Up > 70 AND Aroon Up > Aroon Down
3. RSI 45-75
4. ADX > 20
...
class AroonMomentum1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
    ...
    def __init__(self):
        ...
        self.aroon = bt.indicators.AroonUpDown(self.data, period=self.p.aroon_period)
    ...
    def next(self):
        ...
        # Aroon bullish
        aroon_bullish = (self.aroon.aroonup[0] > self.p.aroon_min and
                         self.aroon.aroonup[0] > self.aroon.aroondown[0])
