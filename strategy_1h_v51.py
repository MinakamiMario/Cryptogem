"""
V51: 1H Ultra-Wide ADX v3 (V49 + ADX rising)
-----------------------------------------------
V49 was +50.6% with 88 trades.
Instead of just ADX > 20, also require ADX to be RISING.
Rising ADX = trend is strengthening = better entry timing.
Also widen RSI to 40-78 for more entries.
...
class UltraWideADXv3_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
