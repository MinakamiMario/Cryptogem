"""
V70: 1H VWAP Trend v5 (V55 + Shorter Cooldown 4)
---------------------------------------------------
V55 was +53.4% with cooldown 8. V68 showed that shorter cooldown
gives more entries. Try V55 exact setup but with cooldown 4 only.
This should capture more re-entries in the same trend.
...
class VWAPTrendV5_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
