"""
V62: 1H Ultimate Hybrid (VWAP + ADX + Supertrend + Triple EMA)
-----------------------------------------------------------------
Combine the top 3 best indicators from this round:
- V55 VWAP (+53.4%, PF 1.32) - price > volume-weighted average
- V49 ADX (+50.6%, PF 1.30) - trend strength confirmation
- V57 Supertrend (+49.9%, PF 1.30) - trend direction

Use ALL three as entry confirmation for maximum reliability.

Entry:
1. Triple EMA aligned (20>50>100) + EMA20 rising
2. Price > VWMA(20) (above volume-weighted fair value)
3. ADX > 18 (slightly lower since Supertrend also filters)
...
class UltimateHybrid1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
