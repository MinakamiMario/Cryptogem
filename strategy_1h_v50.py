"""
V50: 1H Ultra-Wide ADX v2 (V49 + lower ADX threshold)
--------------------------------------------------------
V49 was +50.6% with 88 trades. Best 1H!
ADX > 20 may be too strict. Try ADX > 15 for more trades.

Same as V49 but ADX threshold lowered from 20 to 15.
...
class UltraWideADXv2_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
