"""
V49: 1H Ultra-Wide Momentum v6 (V43 + ADX trend strength)
------------------------------------------------------------
V43 was +31.6% with 102 trades.
Add ADX to only enter when trend is STRONG:
- ADX > 20 = confirmed trend (not ranging)
- This should improve win rate by avoiding choppy markets

Same entry logic as V43 + ADX filter.
Same 6x ATR trailing stop.
...
class UltraWideMomentumADX_1H(bt.Strategy):
    params = (
        ('fast_period', 20),
        ('mid_period', 50),
        ('slow_period', 100),
